...
<head>
    ...
    <!-- Vite Assets -->
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/css/style.css','resources/js/mobile-nav/index.js', 'resources/css/modal-styles.css', 'resources/css/mobile-nav-optimized.css', 'resources/js/app.js']); ?>
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr@4.6.9/dist/flatpickr.min.css">
    ...
    <?php if(env('APP_ENV') === 'local' || env('APP_DEBUG')): ?>
        <?php echo app('Illuminate\Foundation\Vite')(['resources/js/navigation-scroll-tester.js']); ?>
    <?php endif; ?>
...
<body class="mobile-only-mode">
    ...
    <script src="<?php echo e(asset('js/mobile-nav-diagnostics.js')); ?>"></script>
    <?php endif; ?>
    ...
    <script src="<?php echo e(asset('js/media-upload-diagnostics.js')); ?>"></script>
    <script src="<?php echo e(asset('mobile-nav-diagnostics.js')); ?>"></script>
    <?php if(request()->is('templates/editor*') || request()->is('client/templates/editor*')): ?>
        <script src="<?php echo e(asset('js/template-editor-diagnostics.js')); ?>"></script>
    <?php endif; ?>
    <?php endif; ?>
</body>
