    ...
    <div class="mb-fixed-container">
        <div class="mb-scroller" id="nav-scroll-container">
            <div class="mb-icons-container" id="nav-icons-container">
                <?php if(request()->is('media/editor*') || request()->is('templates/create*') || request()->is('templates/editor*')): ?>
                    ...
                    <?php if(request()->is('media/editor*')): ?>
                    ...
                    <?php elseif(request()->is('templates/create*') || request()->is('templates/editor*')): ?>
                        <div class="mb-icon-wrapper" data-icon-id="save" data-popup-on-click="false">
                ...
                <div class="mb-icon-wrapper" data-icon-id="templates" data-popup-on-click="true">
                    <a href="<?php echo e(Auth::check() ? route('my-templates') : route('public-templates')); ?>" class="mb-nav-link <?php echo e(request()->routeIs('my-templates', 'public-templates') ? 'mb-active' : ''); ?>">
                        <div class="mb-nav-icon-wrap">
                                <img src="<?php echo e(asset('images/icons/person.svg')); ?>" class="mb-nav-icon" alt="Шаблоны" draggable="false">
                            </div>
                    </a>
                </div>
...
<?php echo app('Illuminate\Foundation\Vite')(['resources/js/mobile-nav-wheel-picker.js']); ?>
...
<link rel="stylesheet" href="<?php echo e(asset('css/mobile-nav-optimized.css')); ?>">

<!-- Добавляем дополнительный скрипт для обработки кнопок на страницах шаблонов -->
<?php if(request()->is('templates/create*') || request()->is('templates/editor*')): ?>
<script>
    document.addEventListener('DOMContentLoaded', function() {
