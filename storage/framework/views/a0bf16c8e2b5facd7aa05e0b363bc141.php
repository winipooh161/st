        ...
        <?php if(Auth::check()): ?>
            <div class="modal-panel-body">
                <div class="text-center mb-4">
                    ...
                    ?>
                    <p class="badge bg-primary mt-2" id="user-sup-balance">SUP: <?php echo e($supBalance); ?></p>
                </div>
                <?php else: ?>
                <div class="modal-panel-body">
                    <div class="text-center mb-4">
                        <div class="avatar-upload-container position-relative mx-auto" style="">
                            <img src="<?php echo e(asset('images/default-avatar.jpg')); ?>"
                                class="profile-avatar w-100 h-100"
                                alt="Аватар пользователя"
                                style="object-fit: cover;">
                        </div>
                    ...
                    <div class="alert alert-info text-center">
                        Для доступа к профилю, пожалуйста, <a href="<?php echo e(route('login')); ?>" class="alert-link">авторизуйтесь</a>.
                    </div>
                </div>
                <?php endif; ?>
                ...
                <form id="profile-update-form" action="<?php echo e(route('user.update-profile')); ?>" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="profile-birth-date" 
                            name="birth_date" value="<?php echo e(Auth::user()->birth_date ? \Carbon\Carbon::parse(Auth::user()->birth_date instanceof \DateTime ? Auth::user()->birth_date->format('Y-m-d') : Auth::user()->birth_date)->format('Y-m-d') : ''); ?>">
                    </div>
                ...
                <?php else: ?>
                    <div class="text-center py-4">
                        <p class="mb-3">Пожалуйста, войдите в систему, чтобы управлять своим профилем</p>
