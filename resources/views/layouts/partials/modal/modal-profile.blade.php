            ...
            <div class="modal-panel-body">
                ...
                <div class="modal-panel-body">
                    ...
                    <div class="alert alert-info text-center">
                        Для доступа к профилю, пожалуйста, <a href="{{ route('login') }}" class="alert-link">авторизуйтесь</a>.
                    </div>
                </div>
                @endif
                ...
                <form id="profile-update-form" action="{{ route('user.update-profile') }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="profile-birth-date" 
                            name="birth_date" value="{{ Auth::user()->birth_date ? \Carbon\Carbon::parse(Auth::user()->birth_date instanceof \DateTime ? Auth::user()->birth_date->format('Y-m-d') : Auth::user()->birth_date)->format('Y-m-d') : '' }}">
                    </div>
